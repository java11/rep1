...
;(function ($) {
	...
	$.jBar = function (options) {
		...
		var jbar_html = '<div id="jbar" class="jbar">' + '<span class="jbar-cta">' + '<p class="text">' + calltoAction + '<a href="' + buttonLink + '">' 
						+ buttonText + '</a></p>' + '<p class="downarrow"><img src="'+imagesPath+'img/arrow-up.png" class="jtrigger arrow" alt="Arrow Up"></p>' 
						+ '</span></div>' + '<span class="jribbon"><img src="'+imagesPath+'img/arrow-down.png" class="arrow jtrigger" alt="Arrow Down"></span>';
